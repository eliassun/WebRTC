...
string capture_screen(std::string imgpath) {
   std::string result = exec(std::string("/usr/sbin/screencapture -C -x " + imgpath + "/picap.png").c_str());
   return encode_image(std::string(imgpath + "/picap.png").c_str());
}
